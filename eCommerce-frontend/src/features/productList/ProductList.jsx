...
import { fetchProductsAsync, fetchProductsFilterAsync, selectAllProducts} from "./ProductListSlice";
                  ...
                  <div>
                    <div className="bg-white">
                      <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6 sm:py-2 lg:max-w-7xl lg:px-8">
                        <div className=" mt-6 p-4 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="/product-details">
                              <div key={product.id} className="group relative p-4 shadow-2xl rounded-md">
